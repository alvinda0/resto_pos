// dialogs/add_product_dialog.dart
import 'dart:io';
...
class _AddProductDialogState extends State<AddProductDialog> {
  ...
  Widget _buildHeader() {
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.add_box, color: Colors.blue.shade600, size: 24),
      ...
      children: [
        Row(
          children: [
            ...
            Tooltip(
              message: 'Pilih resep jika produk ini menggunakan resep tertentu',
              child: Icon(
                Icons.info_outline,
                size: 16,
        ...
        const SizedBox(height: 8),
        Obx(() {
          // Show loading indicator if recipes are being loaded
          ...
          final availableRecipes = recipeController.recipes.toList();

          return DropdownButtonFormField<String>(
            value: _selectedRecipeId,
            decoration: InputDecoration(
              hintText: 'Pilih resep (opsional)',
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(8),
                borderSide: BorderSide(color: Colors.grey.shade300),
              ),
            ...
            items: [
              const DropdownMenuItem<String>(
                value: null,
                child: Text('Tidak menggunakan resep'),
              ),
              ...availableRecipes.map((recipe) => DropdownMenuItem<String>(
                    value: recipe.id,
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      mainAxisSize: MainAxisSize.min,
        ...
        // Add refresh button if recipes failed to load
        Obx(() {
            ...
            return Padding(
              ...
              child: Row(
                children: [
                  ...
                  TextButton(
                    onPressed: () =>
                        recipeController.loadRecipes(showLoading: false),
                    style: TextButton.styleFrom(
                      padding: const EdgeInsets.symmetric(horizontal: 8),
                      minimumSize: const Size(0, 32),
                    ),
