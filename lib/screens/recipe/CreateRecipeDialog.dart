              ...
              children: [
                ...
                Obx(() => ElevatedButton(
                      onPressed: controller.isOperationLoading.value
                          ? null
                          : () async {
                              final success = await controller.createRecipe();
                              if (success) {
                                Get.back();
                              }
                            },
                ...
                Container(
                  ...
                  child: Obx(() => DropdownButtonFormField<String>(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: item.inventoryId.isNotEmpty
                              ? IconButton(
                                  onPressed: () {
                        ...
                        items: controller.availableInventories
                        ...
                        onChanged: (value) {
                          if (value != null) {
                            final selectedInventory = controller
                            ...
                            final updatedItem = RecipeItem(
                              ...
                              totalCost: item.requiredQuantity *
                                  selectedInventory.price,
                              notes: '',
                              hpp: item.requiredQuantity *
                                  selectedInventory.price,
                            );
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (value) {
                      ...
                      final selectedInventory = controller.availableInventories
